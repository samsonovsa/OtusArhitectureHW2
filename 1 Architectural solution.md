...
Данное архитектурное решение представляет собой микросервисную архитектуру с использованием очереди сообщений для асинхронного взаимодействия сервисов.
В системе используются следующие ключевые компоненты и сервисы:
